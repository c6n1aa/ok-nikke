...
9. Report the commit subject, tag, remote, and whether the push succeeded. CI publishing (release assets plus the CNB mirror tag) is a separate, slower step: report it as pending until the workflow finishes.
