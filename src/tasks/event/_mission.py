...
from src.tasks.event._const import (
    _MISSION_CLAIM_MAX_CLICKS,
    _MISSION_CLAIM_SETTLE,
    _MISSION_CLAIM_SETTLE_TIMEOUT,
    _MISSION_DAILY_SUBTITLE_BOX,
    _MISSION_ICON_BOX,
    _MISSION_READY_TIMEOUT,
    _MISSION_SUBTITLE_BOX,
    _MISSION_SUBTITLE_TEXT,
    _MISSION_TAB_SWITCH_TIMEOUT,
    _MISSION_TABS,
)
