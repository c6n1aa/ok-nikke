...
from src.tasks.event._const import (
    _STORY_MODES, _STORY_BATTLE_TIMEOUT, _STORY_MAX_BATTLES, _STORY_FIELD_CHANGED_FEATURE,
    _STORY_FIELD_CHANGED_WAIT, _STORY_MAX_PUSH_ROUNDS, _STAGE_ENTER_TIMEOUT, _STAGE_DETAIL_BATTLE_BOX,
    _BATTLE_AFTER_SLEEP, _SWEEP_STAGE_DEFAULT, _SWEEP_MAX_ROUNDS, _SWEEP_QUICK_BOX, _SWEEP_CLOSE_FEATURE,
    _SD_ARRIVE_TIMEOUT, _STORY_MENU_PATTERNS,
)
